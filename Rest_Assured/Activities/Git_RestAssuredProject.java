...
public class Git_RestAssuredProject {
	String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIODKU/MPn8GQbvStMgw6k8AvWDQB5gBSFIeahBD0tFIv";
    int sshKeyId;

    // Request specification
    RequestSpecification requestSpec = new RequestSpecBuilder().
            setBaseUri("https://api.github.com/user/keys").
            addHeader("Authorization", "token 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").
