...
public class Activity4 {
    ...
    public void contactsTest() {
    	//Find phone icon and click
    	driver.findElement(AppiumBy.accessibilityId("Phone")).click();
    	
        // Find and click the add button
        driver.findElement(AppiumBy.androidUIAutomator("UiSelector().text(\"Create new contact\")")).click();
        ...
        Assert.assertEquals(contactName, "Sasikant Nair");
        System.out.println("Test pass. Husband's contact added : " + contactName);
    }
